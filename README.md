...
- `res` folder stands for *"resources"*: all additional files that provide some value and could be used for reference would go here (useful links, books, pdfs, slides…).
- `src` folder stands for *"source"*: all *raw* code files would go here, such as `.md`, `.puml`, `...`.  
    * `deliverables`: this folder would hold all `.md` documents to be delivered .
    * `diagrams`: this folder would contain all `.puml` or other similar diagram related source code.
